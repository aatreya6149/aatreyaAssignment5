...
function addTax(amount){
     if(amount instanceof Array){
         let tax = parseFloat((amount[1] * 0.0925).toPrecision(1));
            amount.splice(2,0,tax);
            return amount;
           
        }
        
    }
    a = addTax([9.99, 1.89, 2.99, 3.89])
    console.log(a)
...
a= completeOrder(["Burger", "Pizza", "fries", "soda"])
console.log(a)
...
console.log(getLastElement([15,13,89,189,356]))
...
console.log(combineArrays(['Cow', 'Parrot', 'Giraffe'], [3,9,7,5]))
